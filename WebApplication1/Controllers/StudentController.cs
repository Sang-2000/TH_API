...
namespace WebApplication1.Controllers
{
    public class StudentController : ApiController
    {
        ...
        {
            _conn = new SqlConnection(@"Data Source=DESKTOP-LDKJOLM\SQLEXPRESS;Initial Catalog=Nawab; user id=sa; password=123");
        ...
        public string Post([FromBody] createStudent value)
        {
            _conn = new SqlConnection(@"Data Source=DESKTOP-LDKJOLM\SQLEXPRESS;Initial Catalog=Nawab; user id=sa; password=123");
            DataTable _dt = new DataTable();
            var query = "insert into Student (f_name, m_name, l_name, address, birthDate, score) " +
                        "values (@f_name, @m_name, @l_name, @address, @birthDate, @score)";
